...
class Critic(lagom.nn.Module):
    def __init__(self, config, env, **kwargs):
        ...
        # Q1
        self.Q1_layers = lagom.nn.make_fc(obs_action_dim, [400, 300])
        self.Q1_head = nn.Linear(300, 1)
        # Q2
        self.Q2_layers = lagom.nn.make_fc(obs_action_dim, [400, 300])
        self.Q2_head = nn.Linear(300, 1)
